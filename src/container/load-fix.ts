 ...
 * readers must never import the upgrade layer (that would invert layering and blend different C#
 * symbols — see AGENTS.md "split, don't blend"). Defining the seam type where it is consumed lets the
