...
// (TTMP.cs:918-932) — the version gate (TTMP major < 2, or major==2 && minor==0, needs the tex
...
// fix-before-collapse ordering (WizardData.cs:706-743). This module now owns only the gate,
 ...
 * major < 2, or major == 2 && minor == 0. Mirrors DoesModpackNeedFix (TTMP.cs:918-932): an
 ...
 * `ttmpNeedsTexFix` over its parsed TTMPVersion. Mirrors DoesModpackNeedFix (TTMP.cs:918-932).
 */
